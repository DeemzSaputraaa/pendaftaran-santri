...
<div class="grid lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <!-- Welcome Card -->
        <div class="bg-gradient-to-r from-primary-DEFAULT to-primary-600 rounded-2xl p-8 text-white shadow-xl shadow-primary-DEFAULT/20 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h1 class="text-2xl font-bold mb-2">Assalamu'alaikum, Calon Santri A!</h1>
                <p class="text-primary-100 mb-6 max-w-lg leading-relaxed">Selamat datang di sistem pendaftaran santri baru Pesantren Al-Hikmah. Lengkapi seluruh persyaratan agar Anda dapat segera dijadwalkan untuk tes masuk.</p>
                ...
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm shadow border border-white/30 rounded-lg text-white text-sm">
                    Status saat ini: <strong class="font-bold tracking-wide">MENUNGGU PEMBAYARAN Pendaftaran</strong>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
            <h3 class="text-lg font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">Tahapan Pendaftaran Anda</h3>
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-4 items-start">
                    <div class="w-8 h-8 rounded-full border-4 border-primary-100 bg-primary-DEFAULT flex items-center justify-center text-white shrink-0 mt-1 shadow-lg shadow-primary-DEFAULT/30 shadow">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 p-4 bg-amber-50 rounded-lg border border-amber-200 text-amber-800 text-sm flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="opacity-80">Silakan bayar biaya pendaftaran sebesar Rp 300.000 ke rekening BSI 1234567890 an. Pesantren Al-Hikmah. Lalu unggah bukti transfer di menu "Pembayaran".</p>
                                <a href="#" class="inline-block mt-3 bg-amber-500 hover:bg-amber-600 px-4 py-1.5 rounded text-white font-medium transition-colors">Bayar Sekarang</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-4 items-start opacity-40">
                    <div class="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-slate-500 shrink-0 mt-1 font-bold text-xs">
                        3
                    </div>
                    <div>
                ...
                <div class="flex gap-4 items-start opacity-40">
                    ...
                    <div>
                        <h4 class="font-bold text-slate-800 text-lg">Peserta Pendaftaran & Pengumuman</h4>
                        <p class="text-sm text-slate-500 mt-1">Cetak kartu pendaftaran untuk dibawa saat ujian wawancara.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            <h3 class="text-slate-800 font-bold mb-4 flex items-center gap-2">
                <svg class="w-5 h-5 text-primary-DEFAULT" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Pusat Informasi
            </h3>
            <ul class="space-y-4 text-sm text-slate-600">
                <li class="flex items-start gap-3">
                    <span class="text-primary-DEFAULT font-bold">•</span>
