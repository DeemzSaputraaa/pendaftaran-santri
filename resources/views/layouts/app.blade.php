...
<div class="min-h-screen flex flex-col md:flex-row">
    ...
    <aside class="w-full md:w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col min-h-screen">
        <div class="h-20 flex items-center px-6 border-b border-slate-800 bg-slate-950">
            <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-DEFAULT to-primary-600 flex items-center justify-center font-bold mr-3 shadow-md">
                P
            </div>
        ...
        <div class="flex-1 py-6 px-4 space-y-2">
            ...
            <a href="/dashboard" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-800 hover:text-primary-400 transition-colors bg-slate-800 text-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primary-DEFAULT" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Beranda Dashboard
            </a>
    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto">
        <!-- Top header area -->
        <header class="bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200 h-20 flex items-center px-6 lg:px-10 justify-between">
